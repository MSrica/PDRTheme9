...
setwd('C:\\Users\\user\\Desktop\\Faks\\2.god\\2 semestar\\Programski odreden radio\\Projekt\\PDRTheme9')

# Create a directory named 'plots' if it doesn't already exist
if (!file.exists('plots')) dir.create('plots')

# Create a directory named 'distances' if it doesn't already exist
...
for (rowIndex in 23:nrow(sp3Data)-1) {
  ...
  # If row length is 7 that line contains timestamp for the next 32 observations
...
saveData <- function(gpsName, lines, ionVector){
  # Create a file for the current GPS
